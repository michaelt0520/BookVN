...
namespace BookVN.DatabaseFile
{
    public class BookVNContext : DbContext
    {
        public BookVNContext() : base()
        {
            ...
            //this.Database.Connection.ConnectionString = "workstation id=BookVNDA1.mssql.somee.com;packet size=4096;user id=michaelt0520_SQLLogin_1;pwd=haituan205;data source=BookVNDA1.mssql.somee.com;persist security info=False;initial catalog=BookVNDA1";
        }
