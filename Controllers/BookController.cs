...
namespace BookVN.Controllers
{
    public class BookController : Controller
    {
        ...
        public ActionResult AddBook(string BookName, int aID, int gID, int bID, float Price, float Discount, int Inventory, string Content, HttpPostedFileBase Image)
        {
        ...
        [HttpPost]
        public ActionResult EditBook(int id, string BookName, int aID, int gID, int bID, float Price, int Inventory, string Content, HttpPostedFileBase Image)
        {
            // Lấy ảnh bình cho sách
            string path = "";
            if (Image.ContentLength > 0)
